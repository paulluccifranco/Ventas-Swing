...
public class Unidades extends javax.swing.JInternalFrame {
    Boolean nuevo = false;
    TablaUnidades v = new TablaUnidades();
    ...
    JTable tabla;
    JTextField txtTotal;
    ConexionUnidades conn = new ConexionUnidades();
    Boolean eligio = false;
    FiltrosTextField filtros = new FiltrosTextField();
    public Unidades(JTable table, JTextField txtTot, JPanel punidad, JPanel pbebida, JScrollPane sunidad, JScrollPane sbebida) {
        initComponents();
        txtTotal = txtTot;
        tabla = table;
        pUnidad1 = punidad;
        ...
        public void valueChanged(ListSelectionEvent event) {
                ...
                txtPrecio.setText(tablap.getValueAt(tablap.getSelectedRow(), 3).toString());
                txtPrecioPedidosya.setText(tablap.getValueAt(tablap.getSelectedRow(), 4).toString());
    ...
    private void initComponents() {
        ...
        cmbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Comida", "Bebida" }));
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        ResultSet rs = conn.SeleccionarUnidades("", 0);
        ...
        try{
            while(rs.next()){
                ...
                if(tipo == 0){
                    ...
                    pUnidad1.add(por);
                    tUnidad = tUnidad + 65;
                    pUnidad1.setPreferredSize(new Dimension(180,tUnidad));
                }
                if(tipo == 1){
                    por.setLocation(1,tBebida);
                    pBebida1.add(por);
                    tBebida = tBebida + 65;
                    pBebida1.setPreferredSize(new Dimension(180,tBebida));
                }
            }
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if(nuevo == true){
            conn.guardar(nombre1, precio1, tipo1, precio2);
        }
        else{
            Integer id = Integer.parseInt(txtIdProducto.getText());
            conn.editarUnidad(id, precio1, precio2); 
        }
